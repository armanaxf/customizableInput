...
export class FieldControl implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    private _props: IFieldControlProps
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): React.ReactElement {
        ...
        this._props.Placeholder = context.parameters.Placeholder.raw || ""
        this._props.Orientation = context.parameters.Orientation.raw
    ...
    public getOutputs(): IOutputs {
        console.log("getOutputs, this._value: " + JSON.stringify(this._value));
        return { Value: this._value } as IOutputs;
    }
